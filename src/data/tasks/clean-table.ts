  ...
  objects: [
    {
      ...
      category: 'cup',
      initialRoom: 'dining',
      initialPosition: { x: 15.4, y: 0, z: 0 },
    ...
    },
    {
      ...
      category: 'tissue',
      initialRoom: 'dining',
      initialPosition: { x: 16.6, y: 0, z: 0 },
      surfaceContainerId: 'cnt-dining-table',
    ...
    },
    {
      ...
      category: 'fork',
      initialRoom: 'dining',
      initialPosition: { x: 16, y: 0, z: -0.3 },
      surfaceContainerId: 'cnt-dining-table',
