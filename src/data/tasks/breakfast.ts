...
🎯 目标：准备早餐 → 吃完归位 → 所有容器关好`,
  ...
  objects: [
    // 牛奶 - 在冰箱里（需要先打开）
    {
      ...
      category: 'milk',
      initialRoom: 'kitchen',
      initialPosition: { x: 4.5, y: 0.6, z: 0 },
    ...
    // 麦片盒 - 初始在下层橱柜
    {
      ...
      category: 'cereal',
      initialRoom: 'kitchen',
      initialPosition: { x: 7.5, y: 0.6, z: 0 },
    ...
    // 杯子 - 在下层橱柜
    {
      ...
      category: 'cup',
      initialRoom: 'kitchen',
      initialPosition: { x: 7.0, y: 0.6, z: 0.2 },
    ...
    // 碗 - 在下层橱柜
    {
      ...
      category: 'bowl',
      initialRoom: 'kitchen',
      initialPosition: { x: 7.3, y: 0.6, z: 0.4 },
