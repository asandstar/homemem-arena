...
💡 小贴士：
  · 按衣服颜色分类：白色衣物 → 白色篮 / 深色衣物 → 深色篮 / 毛巾 → 毛巾篮
  · 神秘彩色条纹衬衫：翻开领子看水洗标写着「WHITE 40°」，归类到白色衣物篮！
  · 袜子幽灵会偷偷挪动物体位置！如果原来的位置找不到，记得按 E 更新记忆后再找～`,
  ...
  objects: [
    {
      ...
      initialRoom: 'laundry',
      initialPosition: { x: -1.2, y: 0.4, z: 1.0 },
    ...
    },
    {
      ...
      category: 'white-clothes',
      initialRoom: 'laundry',
      initialPosition: { x: -1.2, y: 0.05, z: 1.3 },
    ...
    },
    {
      ...
      category: 'white-clothes',
      initialRoom: 'laundry',
      initialPosition: { x: -1.2, y: 0.4, z: 1.5 },
    ...
    },
    {
      ...
      category: 'white-clothes',
      initialRoom: 'laundry',
      initialPosition: { x: -1.0, y: 0.05, z: 1.5 },
      size: { x: 0.4, y: 0.05, z: 0.5 },
      color: '#ec4899',
  ...
  scriptedEvents: [
    {
      ...
      targetPosition: { room: 'laundry', x: 1.0, y: 0.05, z: 1.3 },
    ...
    },
    {
      ...
      targetPosition: { room: 'laundry', x: -1.5, y: 0.05, z: 1.6 },
