...
- **捣乱事件** — 钥匙猫、袜子幽灵、物品会被偷偷移动，考验记忆更新能力
...
| 关 | 章节 | 时间 | 记忆类型 | 核心玩法 |
|:---:|:---|:---:|:---|:---|
| 1 | **失忆管家初次启动** | 🥣 上午 07:00 | 程序性 | 教学关，熟悉操作。把 9 件餐具按类别归位（杯勺→水槽，盘叉→橱柜），记忆基础交互流程 |
| 2 | **钥匙猫的清晨恶作剧** | 🚪 上午 08:00 | 空间 | 跨房间寻物。钥匙猫把 4 件物品（书、马克杯、小熊、收音机）藏到全屋各房间，90 秒内找回并放回客厅茶几 |
| 3 | **洗衣房的袜子幽灵** | 👕 下午 15:00 | 时间+物体+空间+程序性 | 6 件衣物按颜色/材质分到 3 个洗衣篮。袜子幽灵会偷偷交换篮子位置——不能靠位置记忆，只能靠颜色和记忆槽 |
...
- 移除第 4 关（早餐记忆更新）和第 5 关（深夜巡逻），聚焦打磨前三关可玩性
