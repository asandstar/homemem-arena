...
| 顺序 | 时间 | 关卡 | 角色 | 主要记忆能力 | 核心挑战 |
|:---:|:---:|:---|:---:|:---|:---|
| 1 | 🍽️ 第一天上午 | 初次整理（餐桌整理） | 📖 基础教学 | 空间、物体、程序 | 教学关卡，学会 **保存与使用记忆** 的基本操作 |
| 2 | 🌅 清晨 8:00 | 出门大作战 | ⭐ 核心挑战 | 空间、物体 | 跨房间找物品，应对钥匙猫恶作剧，**识别并更新过期记忆** |
| 3 | 👕 上午 10:00 | 洗衣幽灵 | 🎯 进阶挑战 | 计数、物体、空间、时序 | 分类衣物，幽灵移动物品，**有限记忆与多目标管理** |

> 内部代码与任务数据中保留了后续关卡（task-breakfast、task-night-patrol），用于研发迭代与未来版本；当前生产环境普通 UI 与路由不对外暴露。
